...
def new_helper(name, number, parent):
...
def test_experment_new():
    ...
    new_helper('nasnet', '00', test_experiment)
    new_helper('vgg_16', '01', test_experiment)
    new_helper('inception_v3', '02', test_experiment)

    test_sub_experiment = test_experiment.new('adam')

    new_helper('001', '00', test_sub_experiment)
    new_helper('0001', '01', test_sub_experiment)
